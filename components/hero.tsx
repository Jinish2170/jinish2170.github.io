...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center pt-16 pb-8 relative" itemScope itemType="https://schema.org/Person">
      ...
      <div className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4">
            ...
            <span className="tech-gradient text-5xl sm:text-6xl md:text-7xl block mt-2 glow-text" itemProp="name">
              Jinish Kathiriya
            </span>
          </h1>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.3 }}>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-textSecondary h-10 sm:h-12 md:h-14 flex justify-center items-center" itemProp="jobTitle">
        ...
        >
          Aspiring Tech Founder passionate about cybersecurity and AI innovations. Technical Head at Google Developer Group (GDG) CKPCET, currently pursuing B.E. in Computer Engineering at GTU in Surat, Gujarat.
        </motion.p>
